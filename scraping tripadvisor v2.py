...
while pagina < 298:
    try: 
        ...
        puntuacion = sel.css("div.location-review-review-list-parts-RatingLine__bubbles--GcJvM").extract()
...
modelo = Sequential()
modelo.add(Dense(50, activation="relu", input_shape=(5267,)))
